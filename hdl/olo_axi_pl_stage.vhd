...
entity olo_axi_pl_stage is
    ...
    port (
        ...
        S_AwLen    : in    std_logic_vector(LenWidth_g-1 downto 0)    := (others => '0');
        ...
        S_ArLen    : in    std_logic_vector(LenWidth_g-1 downto 0)    := (others => '0');
        ...
        M_AwLen    : out   std_logic_vector(LenWidth_g-1 downto 0);
        ...
        M_ArLen    : out   std_logic_vector(LenWidth_g-1 downto 0);
